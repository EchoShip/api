...
## Additional links`;
  ...
  options
    ...
    .setTitle(`@depsdev/depsdev.github.io/api`)
    .setDescription(markdownDescription)
    .setVersion(`1`)
    .setContact("Open Sauced", "https://depsdev.github.io", "hello@depsdev.github.io")
    .setTermsOfService("https://github.com/depsdev/code-of-conduct")
