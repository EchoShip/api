...
export class DbRepo extends BaseEntity {
  ...
  @ApiModelProperty({
    ...
    example: "git://github.com/depsdev/insights.git",
  })
  @Column({
    type: "character varying",
    length: 255,
  ...
  @ApiModelProperty({
    ...
    example: "https://github.com/depsdev/insights.git",
  })
  @Column({
    type: "character varying",
    length: 255,
  ...
  @ApiModelProperty({
    ...
    example: "https://github.com/depsdev/insights",
  })
  @Column({
    type: "character varying",
    length: 255,
  ...
  @ApiModelProperty({
    ...
    example: "https://api.github.com/repos/depsdev/insights",
  })
  @Column({
    type: "character varying",
    length: 255,
  ...
  @ApiModelProperty({
    ...
    example: "https://app.depsdev.github.io",
  })
  @Column({
    type: "character varying",
    length: 255,
  ...
  @ApiModelProperty({
    ...
    example: ["depsdev", "open-source", "github"],
  })
  @Column({
    type: "varchar",
    array: true,
